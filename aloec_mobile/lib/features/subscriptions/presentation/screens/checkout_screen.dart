...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Pagar con Payphone',
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 8),
                          const Text(
                            'Paga de forma segura desde tu app Payphone',
                            textAlign: TextAlign.center,
                            ...
                            Row(
                              ...
                              children: [
                                const Text('Duración:',
                                    style: TextStyle(
                                        color: Colors.grey, fontSize: 14)),
                                Text('${membership.durationDays} días',
                                    style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14)),
                              ],
                    ...
                    // Campo de teléfono
                    const Text('Tu número de teléfono Payphone',
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 16)),
                    const SizedBox(height: 4),
                    const Text(
                      'Ingresa el número registrado en tu cuenta Payphone. Recibirás una notificación para aprobar el pago.',
                    ...
                    TextFormField(
                      ...
                      validator: (v) {
                        if (v == null || v.replaceAll(RegExp(r'[^0-9]'), '').length < 9) {
                    ...
                    AloecButton(
                      text: membership != null
                          ? 'Pagar \$${membership.price.toStringAsFixed(2)} con Payphone'
                          : 'Pagar con Payphone',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          _stepRow('1', 'Ingresa tu número de Payphone'),
                          _stepRow('2', 'Recibirás una notificación en tu app Payphone'),
                          _stepRow('3', 'Aprueba el pago con tu huella o contraseña'),
                          _stepRow('4', '¡Listo! Tu membresía se activa al instante'),
                        ],
                      ),
                    ),
                    const SizedBox(height: 12),
                    const Center(
                      child: Text(
                        '🔒 Transacción segura procesada por Payphone',
